 ...
 */
final class Version20251118142802 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE academic_calendar (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, start_date DATE NOT NULL, end_date DATE NOT NULL, holidays JSON NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE lesson_schedule (id INT AUTO_INCREMENT NOT NULL, lesson_id INT NOT NULL, date DATE NOT NULL, INDEX IDX_127F5BE2CDF80196 (lesson_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE lesson_schedule ADD CONSTRAINT FK_127F5BE2CDF80196 FOREIGN KEY (lesson_id) REFERENCES lesson (id)');
